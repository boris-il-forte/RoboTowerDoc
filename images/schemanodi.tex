...
\draw [<-,thick, shorten >=1pt, shorten <=1pt,postaction={decorate,decoration={raise=1ex,text along path,text align=center,text={|\sffamily|spykee motion}}}] (spykee) to (isaac);
...
\draw [<-,thick, shorten >=1pt, shorten <=1pt,postaction={decorate,decoration={raise=1ex,text along path,text align=center,text={|\sffamily|led (servizi)}}}] (echoes) to [bend left=7]  (isaac);
...
\draw [->,thick, shorten >=1pt, shorten <=1pt,postaction={decorate,decoration={raise=1ex,text along path,text align=center,text={|\sffamily|led (servizi)}}}] (echoes) to [bend left=7]  (robotowergame);
