...
\end{itemize}
Inoltre, la regola CanGoBack permette di ottenere in uscita un valore che indica, in base ai valori ricevuti dal sonar posteriore, se il robot può o meno muoversi all'indietro senza andare a sbattere. Questo valore viene utilizzato da IsAac durante l'attivazione dell'azione \verb|go_back| associata alla trappola.
